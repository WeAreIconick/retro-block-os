<?php
/**
 * Retro Block Os Starter Content
 *
 ...
 *
 * Passes it through the `retro_block_os_starter_content` filter before returning.
 *
...
function get_starter_content() {
	...
	$starter_content = array(
		...
		'posts'       => array(
			'front' => array(
				'post_type'    => 'page',
				'post_title'   => esc_html_x( 'Front Page', 'Theme starter content', 'retro-block-os' ),
...
<!-- /wp:columns -->',
		...
		'attachments' => array(
			'wapuu' => array(
				'post_title' => esc_html_x( 'Wapuu', 'Theme starter content', 'retro-block-os' ),
		...
		'options'     => array(
			...
			'page_for_posts'  => '{{blog}}',
			'site_icon'       => '{{wapuu}}',
			'blogname'        => esc_html_x( 'Retro Block Os', 'Theme starter content', 'retro-block-os' ),
			'blogdescription' => esc_html_x( 'Another fine WordPress Block Theme', 'Theme starter content', 'retro-block-os' ),
		),
		...
		'nav_menus'   => array(
			...
			'primary' => array(
				'name'  => esc_html_x( 'Primary menu', 'Theme starter content', 'retro-block-os' ),
				'items' => array(
			...
			'footer'  => array(
				'name'  => esc_html__( 'Footer menu', 'retro-block-os' ),
				'items' => array(
					'link_home',
					'link_news',
					'link_email',
					'link_github' => array(
						'title' => esc_html_x( 'Retro Block Os', 'Theme starter content', 'retro-block-os' ),
						'url'   => 'https://github.com/WeAreIconick/retro-block-os/',
					),
				),
			),
		),
	 ...
	 */
	return apply_filters( 'retro_block_os_starter_content', $starter_content );
}
